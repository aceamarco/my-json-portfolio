...
function ProjectCard({
  ...
  social_media_links = [{ type: 'github', url: 'https://github.com/aceamarco' }] // Default social media link
}) {
  return (
        ...
        {portfolio.map((project, index) => (
          <Col key={index}>
            <ProjectCard
              ...
              social_media_links={project.links ? Object.entries(project.links).map(([type, url]) => ({ type, url })) : []}
            />
          </Col>
        ))}
      </Row>
